...
public class SharedResources {
    ...
    public static final String APPLICATIONNAME = "DS Cars";
    public static final int PLAYER_1 = 1; //Magic number
    public static final int PLAYER_2 = 2; //Magic number
    ...
    public static final String MB_Help_About_Content =
            "DS Cars is a car racing game, where the players’ goal is to go race around the arena without hitting into each other. \n" +
                    ...
                    "\n" +
                    "- 2 Game modes: Single player and Multiplayer of 2 people on the same computer (side-by-side).\n" +
    ...
    public static final String MB_Help_Control_Content =
            "A car can be controlled with 4 keys. These are described below:\n" +
                    "\n" +
                    "1. Accelerate (Keys: up arrow for Player 1, 'W' for Player 2): \n" +
                    ...
                    "    \n" +
                    "2. Reverse / break (Keys: down arrow for Player 1, 'S' for Player 2)\n" +
                    ...
                    "\n" +
                    "3. Turn left (Keys: left arrow for Player 1, 'A' for Player 2)\n" +
                    ...
                    "\n" +
                    "4. Turn right (Keys: right arrow for Player 1, 'D' for Player 2)\n" +
    ...
    public  static  final String MMS_Menu_SinglePlayer = "Single Player";
    public  static  final String MMS_Menu_SideBySide = "Multiplayer: Side-by-Side";
    ...
    public static final String LS_GameStartButton_Text_Ready = "Start!";
    public static final int LS_GameStartButton_Y = LS_ReturnToMainButton_Y;
    public static final int LS_GameStartButton_Height = LS_ReturnToMainButton_Height;
    ...
    public static final int CSP_Location_Player2_X = CSP_Location_Player1_X;
    public static final int CSP_Location_Player2_Y = 150;
    ...
    public static final float GCS_Maximum_Car_Speed = 8;
    public static final float GCS_Maximum_Car_Reverse_Speed = 4;
    public static final float GCS_Maximum_Car_Grass_Speed = 3;
    ...
    /*     Default game options (controllable from the Menu bar) */
