...
public class ImageFileLoader
{
    ...
    /**
     * Return the image file containing the keyboard layout for a given player.
     * E.g.: Player1: arrows, Player2: W-A-S-D
     *
     * @param PlayerNumber Either 1 or 2. (It is not an index number)
     * @return Returns the image representing the control keys.
     */
    public static Image LoadKeyboardLayoutImage(int PlayerNumber)
    {
        Image result;
        String FileName = SharedResources.CLI_LayoutImage_FilePath + SharedResources.CLI_ImageFileName_NoSubFix + Integer.toString(PlayerNumber) + SharedResources.CLI_ImageFile_FileExtension;
